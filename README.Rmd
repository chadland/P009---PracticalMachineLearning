...
**Tool:** [XGBoost](https://github.com/dmlc/xgboost), an implementation of tree-based extreme gradient boosting algorithm. 

## HTML report page Rpubs ##

Please open [this Rpubs-link](http://rpubs.com/norseman/PracticalMachineLearning).  

The HTML file is stored using RPubs
